...
> Answer: All of your changes are happening on the client-side, so they don't have to wait for a response from a server. This also allows you to use less memory and data. 
